...
## Verification
1. `dc-df --help`, `dc-prune --help`, `dc-up --help`, `dc-doctor --help`, `dc-stats --help` work. `dc-doctor` and `dc-stats` are read-only.
